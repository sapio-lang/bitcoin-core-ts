...
type Categories = 'wallet' | 'network' | 'blockchain' | 'rawtransactions' | 'util' | 'mining' | 'control' | 'generating' | 'logging';
export type Feature = "multiwallet";
export type Method = {
  category: Categories, features?: {} | Record<Feature, Range | { supported: boolean }>, version: Range,
  obfuscate?: {
    request?: {
